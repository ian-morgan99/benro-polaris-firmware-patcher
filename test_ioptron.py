#!/usr/bin/env python3
"""
Test script to capture a frame from the iOptron iPolar UVC device
"""
import sys
import cv2
import numpy as np
...
def test_ioptron():
    print("Testing iOptron iPolar UVC device...")
    ...
    if ret:
        ...
        cv2.imwrite('/tmp/ioptrom_test_frame.png', frame)
        print("Saved frame to /tmp/ioptrom_test_frame.png")
