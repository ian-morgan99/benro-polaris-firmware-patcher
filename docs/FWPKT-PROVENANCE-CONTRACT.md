...
| **o-v9b-reviewed-controls** | `firmware-packets/o-v9b-reviewed-controls/FwPkt.zip` (`ian-morgan99/PrivateResearch`, private) | `215166be90dc3dabc31ae2ca552b6396` | `ac94301e6bccf971` (full: `ac94301e6bccf971544b27ed53e6e82dbe42c3e82d2685731928756665584852`) | `414950000b9a4fd17df18ffd4be2b8e7` | **[`4c2fa7d62`](https://github.com/ian-morgan99/libgphoto2/commit/4c2fa7d62a42171ee981f2a1b502a8b29666642e)** | patcher main @ **[`152bd33`](https://github.com/ian-morgan99/benro-polaris-firmware-patcher/commit/152bd33)** | **BUILD-VALIDATED candidate; PENDING physical qualification** | Clean, self-contained-source rebuild carrying o-v8's corrected Stage-2 Pentax model gate plus reviewed generic `manualfocusdrive`. Guessed `autofocusdrive` and scalar `imageformat` mappings were excluded before build. Dirty-source fail-closed test, structural test, structural/firmwareInfo, ARM ABI/symbol, matched core/port, Stage-2 content, and ZIP-layout gates passed. Do not claim K-01/K-1 II/K-3 III support until the A/B/C physical matrix passes. |
