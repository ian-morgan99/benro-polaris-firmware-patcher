...
| **o-v9d-model-aware-focus** | `firmware-packets/o-v9d-model-aware-focus/FwPkt.zip` (`ian-morgan99/PrivateResearch`, private) | `90968076a1841e46017372a390277a0d` | `f673123958e0d095` (full: `f673123958e0d09576633a113850e7e1226759910528675957ca3b53be016e8e`) | `1068c3b99272f99b9c0d3f033960aee5` | **[`90de508a5`](https://github.com/ian-morgan99/libgphoto2/commit/90de508a5441cb7e2b1b02d601b15a7547d7bcee)** | patcher main @ **[`af5d7d5`](https://github.com/ian-morgan99/benro-polaris-firmware-patcher/commit/af5d7d5)** | **BUILD-VALIDATED candidate; PENDING Polaris qualification** | Exact-model direct-PC audit fixed masked probe lookup and duplicate Pentax near/far registrations. K-1 II and K-3 III each produced 5/5 valid preview JPEGs. Model dispatch selected `0x9016` for K-1 II (bounded `0xa00c`, no movement claimed) and `0x9017` for K-3 III (Near/Far accepted with PC-LV). Structural/firmwareInfo, ARM ABI/symbol, matched-stack, Stage-2 and ZIP-layout gates passed. |
